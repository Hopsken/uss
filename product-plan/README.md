...
This folder contains everything needed to implement **USS**, an AI agent command center for OpenClaw.
...
- `instructions/incremental/` — 7 milestone instructions (shell, then 6 sections)
...
| # | Milestone | Section |
|---|-----------|---------|
| 1 | Shell | Navigation, layout, design tokens |
| 2 | Bridge | Command center overview dashboard |
| 3 | Agents | Agent roster and detail views |
| 4 | Tasks | Kanban task board and templates |
| 5 | Activity | Chronological agent activity feed |
| 6 | Usage | Cost and token dashboard |
| 7 | Skills | Skills configuration manager |
