...
2. **Authentication & users** — How users should sign up, log in, and what permissions exist (or confirm it's a single-user tool with no auth)
3. **Data & backend** — How data will be fetched and stored (REST API, GraphQL, local files, etc.)
